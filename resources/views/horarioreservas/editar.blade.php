...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Horario de Reservas</div>

                <div class="card-body">
                    <form action="{{ route('horarioreservas.update',$horarioreservas->id) }}" method="POST">
                      @csrf
                      @method('put')
                      <div class="form-group">
                        <label>Turno Mañana</label>
                        <input type="text" class="form-control" name="mañana" placeholder="...." value="{{ $trabajadores->nombre }}">
                      </div>
                      <div class="form-group">
